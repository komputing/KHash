...
class TheSHA3 {
    ...
    fun testNistVectors() {
        allNistTestVectors.forEach { (vectorList, params) ->
            vectorList.forEach { (input, expected) ->
                assertThat(input.hexToByteArray().calculateSHA3(params).toNoPrefixHexString())
                        .isEqualTo(expected)
            }
        }
    }
    ...
    fun keccak256hashesAreCorrect() {
        ...
        assertThat("".calculateSHA3(KECCAK_256))
                .isEqualTo("c5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470".hexToByteArray())

        assertThat("The quick brown fox jumps over the lazy dog".calculateSHA3(KECCAK_256))
        ...
        assertThat("The quick brown fox jumps over the lazy dog.The quick brown fox jumps over the lazy dog.The quick brown fox jumps over the lazy dog.The quick brown fox jumps over the lazy dog.The quick brown fox jumps over the lazy dog.The quick brown fox jumps over the lazy dog.The quick brown fox jumps over the lazy dog.The quick brown fox jumps over the lazy dog.The quick brown fox jumps over the lazy dog.The quick brown fox jumps over the lazy dog.The quick brown fox jumps over the lazy dog.The quick brown fox jumps over the lazy dog.The quick brown fox jumps over the lazy dog.The quick brown fox jumps over the lazy dog.The quick brown fox jumps over the lazy dog.The quick brown fox jumps over the lazy dog.The quick brown fox jumps over the lazy dog.The quick brown fox jumps over the lazy dog.The quick brown fox jumps over the lazy dog.".calculateSHA3(KECCAK_256))
                .isEqualTo("e35949d2ca446ea2fd99f49bed23c60e0b9849f5384661bc574a5c55fcaeb4bd".hexToByteArray())

        assertThat("a1b31be4d58a7ddd24b135db0da56a90fb5382077ae26b250e1dc9cd6232ce2270f4c995428bc76aa78e522316e95d7834d725efc9ca754d043233af6ca90113".hexToByteArray().calculateSHA3(KECCAK_256).toHexString(""))
